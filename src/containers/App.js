...
import {onJewelClick, onJewelsCreated, onIntroComplete, onCheckForSequences} from '../actions';
import {JEWEL_CLICK_IN, INTRO_ANIMATION, CHECK_FOR_SEQUENCES, _basicJewelTypes, _numCols, _numRows} from '../constants';
...
/*
    ...
    */
    ...
    render() {
        ...
        console.log(this.props.appData.jewels.length);
